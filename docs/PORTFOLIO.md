...
Keep the metrics in sync with the repo (currently **217 tests: 154 frontend +
63 backend**).
...
> executive dashboard, project-scoped RFI, Submittal, and Punch List
> workflows, and 217 automated tests.
...
>   demo-data onboarding through the public API, and 217 automated tests
...
> inspections, delays, change orders, RFIs, Submittals, Punch Lists) and an
> executive dashboard that answers
...
> with graceful session expiry, and 217 automated tests across the stack.
...
> auth, an accessible component design system, and 217 automated tests.
>
...
> dashboard, project-scoped RFI, Submittal, and Punch List workflows,
> accessible design system, 217 automated tests. Live demo seeds a complete
> sample project in seconds.
