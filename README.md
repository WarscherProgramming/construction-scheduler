...
- **Interactive scheduler**: spreadsheet-style inline editing, multiple
  ...
  parent/child hierarchy, validated subtree ordering, and keyboard-accessible
...
- **Provider-neutral AI preconstruction foundation** with project-owned review
  ...
  lineage/stale detection, and a plain-text source inspector. A controlled
  construction scope taxonomy then produces evidence-backed scope assertions
...
- Independent persistent Schedule Start Date and Data Date with deterministic,
  status-aware recalculation
- Not Started, In Progress, and Completed leaf-task progress with percent
...
- **Backend (435, plus 420 separately reported subtests)** — pytest. Covers the deterministic
  ...
  Data Date persistence, progress lifecycle and correction rules,
  status-aware forecasting, out-of-sequence detection, progress summaries,
  transactional rollback, and progress-aware baseline variance and export,
...
- ✅ M17.3 schedule progress and Data Date semantics with server-normalized
...
- ✅ M18.1 provider-neutral AI preconstruction foundation with project-owned
...
- ✅ M18.3 controlled construction scope taxonomy and evidence-backed,
  human-reviewed scope assertions with immutable assertion sets, deterministic
  content hashes and deduplication, server-derived evidence excerpts,
