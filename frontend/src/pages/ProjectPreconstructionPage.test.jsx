...
function makeState(overrides = {}) {
  return {
    ...
    findingQuery: { search: "", limit: 25, offset: 0 },
    isComparisonLoading: false,
    comparisonError: null,
    loadComparison: vi.fn().mockResolvedValue(null),
    selectComparisonPlan: vi.fn().mockResolvedValue(null),
    createComparisonPlan: vi.fn().mockResolvedValue({}),
    updateComparisonPlan: vi.fn().mockResolvedValue({}),
    archiveComparisonPlan: vi.fn().mockResolvedValue({}),
    runComparison: vi.fn().mockResolvedValue({}),
    reviewFinding: vi.fn().mockResolvedValue({}),
    createManualFinding: vi.fn().mockResolvedValue({}),
    ...overrides,
  };
}
